...
const CtaBanner = ({ label, title, body, ctaLabel, ctaHref }: CtaBannerProps) => {
  ...
  const btn = (
    <span className="group inline-flex items-center gap-2 font-outfit font-medium text-sm text-white bg-well-red hover:bg-well-red/90 px-6 py-3 rounded-full transition-colors mt-2">
      {ctaLabel}
