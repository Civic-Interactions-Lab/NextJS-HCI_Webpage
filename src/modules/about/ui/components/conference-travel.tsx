...
import {
  useSideReveal,
  useStaggerReveal,
} from "@/modules/about/hooks/use-scroll-reveal";
...
const ConferenceTravel = () => {
  ...
  useStaggerReveal(rootRef, ".conference-travel-stat", {
    y: 20,
    stagger: 0.15,
    duration: 0.5,
    start: "top 80%",
  ...
  return (
    ...
    >
      ...
      <div ref={textRef} className="flex flex-col gap-6 order-1">
        <SectionTitle>Conference Travel</SectionTitle>
        <p className="text-p1 text-thunder/75 leading-relaxed">
          ...
          about the direction of their work. They get real opportunities to
          travel and share their research at major national and international
          conferences, an experience that shapes how they see themselves as
          researchers and professionals.
        </p>

        <div className="flex flex-col gap-3 pt-1">
          {CONFERENCE_TRAVEL_STATS.map(({ number, desc }) => (
            <div
              key={number}
              className="conference-travel-stat flex gap-4 items-center border-l-4 border-well-red pl-4 py-1"
            >
              <span className="font-outfit font-bold text-3xl text-well-red shrink-0 leading-none">
                {number}
              </span>
