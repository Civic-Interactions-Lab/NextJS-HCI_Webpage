        ...
        {learningOutcomes.map((outcome) => (
          ...
          >
            <div className="w-full md:w-44 text-center">
              <div
                className={`text-white px-4 md:px-6 py-2 md:py-3 ${outcome.badgeColor} ${outcome.radius} font-medium text-sm md:text-base uppercase inline-block font-outfit`}
              >
                {outcome.category}
              </div>
            </div>
            <p className="body-text flex-1 text-center md:text-left">
              {outcome.description}
            </p>
          </div>
        ))}
